...
protocol CalendarApi {
  ...
  func createEvent(calendarId: String, title: String, startDate: Int64, endDate: Int64, isAllDay: Bool, description: String?, url: String?, reminders: [Int64]?, completion: @escaping (Result<Void, Error>) -> Void)
