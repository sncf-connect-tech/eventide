...
class CalendarActions {
  ...
  Future<bool> requestCalendarAccess() async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.flutter_calendar_connect.CalendarActions.requestCalendarAccess$__pigeon_messageChannelSuffix';
  ...
  Future<Calendar> createCalendar(String title, String hexColor) async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.flutter_calendar_connect.CalendarActions.createCalendar$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[title, hexColor]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
      ...
      return (__pigeon_replyList[0] as Calendar?)!;
    }
  }

  Future<List<Calendar?>> retrieveCalendars() async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.flutter_calendar_connect.CalendarActions.retrieveCalendars$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
    ...
    if (__pigeon_replyList == null) {
      ...
      return (__pigeon_replyList[0] as List<Object?>?)!.cast<Calendar?>();
    }
  }

  Future<bool> createOrUpdateEvent(Event flutterEvent) async {
    final String __pigeon_channelName = 'dev.flutter.pigeon.flutter_calendar_connect.CalendarActions.createOrUpdateEvent$__pigeon_messageChannelSuffix';
    final BasicMessageChannel<Object?> __pigeon_channel = BasicMessageChannel<Object?>(
      __pigeon_channelName,
      pigeonChannelCodec,
      binaryMessenger: __pigeon_binaryMessenger,
    ...
    final List<Object?>? __pigeon_replyList =
        await __pigeon_channel.send(<Object?>[flutterEvent]) as List<Object?>?;
    if (__pigeon_replyList == null) {
      throw _createConnectionError(__pigeon_channelName);
    } else if (__pigeon_replyList.length > 1) {
      throw PlatformException(
