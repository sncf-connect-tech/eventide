...
data class Calendar (
  ...
  companion object {
    ...
    fun fromList(__pigeon_list: List<Any?>): Calendar {
      val id = __pigeon_list[0] as String
      val title = __pigeon_list[1] as String
      val hexColor = __pigeon_list[2] as String
      val sourceName = __pigeon_list[3] as String?
...
data class Event (
  ...
  companion object {
    @Suppress("LocalVariableName")
    fun fromList(__pigeon_list: List<Any?>): Event {
      val id = __pigeon_list[0] as String?
      val title = __pigeon_list[1] as String
      val startDate = __pigeon_list[2].let { num -> if (num is Int) num.toLong() else num as Long }
      val endDate = __pigeon_list[3].let { num -> if (num is Int) num.toLong() else num as Long }
      val calendarId = __pigeon_list[4] as String
      val description = __pigeon_list[5] as String?
      val url = __pigeon_list[6] as String?
      val alarms = __pigeon_list[7] as List<Alarm?>
...
data class Alarm (
  ...
  companion object {
    @Suppress("LocalVariableName")
    fun fromList(__pigeon_list: List<Any?>): Alarm {
      val minutes = __pigeon_list[0].let { num -> if (num is Int) num.toLong() else num as Long }
...
private object CalendarActionsPigeonCodec : StandardMessageCodec() {
